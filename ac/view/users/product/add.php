...
<body>
	...
	<div class="content">
		...
		<table width="90%" border="1" style="background-color: #FC6; margin-left: 50px;">
			...
			<tr >
				<td colspan="2"><input type="submit" name="addProduct" value="Add Product" style="width:100px; height:40px; border:1px solid #000; text-align:center; background:#069; line-height:40px; color:#fff; float:right;"></td>
			</tr>
		</table>
		</form>
	</div>
